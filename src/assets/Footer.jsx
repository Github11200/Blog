...
export const Footer = () => {
    ...
    const [daisyUIHover, setDaisyUIHover] = useState(false);

    return (
        <footer className="bg-accent w-full text-center text-3xl py-7 flex space-x-7 justify-center">
            <p className="inline pt-1">
                <span className="inline-block align-middle">Built using</span>
            </p>
            <div
            ...
            <div
                onMouseEnter={() => setDaisyUIHover(true)}
                onMouseLeave={() => setDaisyUIHover(false)}
                className="inline-block cursor-pointer"
            >
                <a
